...
let%expect_test "types" =
  scan_string "int";
  [%expect{|
    :1.0-1.3 (Parser.ID "int")
    :1.3-1.3 Parser.EOF |}];
  scan_string "bool";
  [%expect{|
    :1.0-1.4 (Parser.ID "bool")
    :1.4-1.4 Parser.EOF |}];
  scan_string "unit";
  [%expect{|
    :1.0-1.4 (Parser.ID "unit")
    :1.4-1.4 Parser.EOF |}]
